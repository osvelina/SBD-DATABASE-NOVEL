...
class PembeliController extends Controller
{
    ...
    public function store(Request $request) {
        ...
        DB::insert('INSERT INTO pembeli(id_pembeli, id_novel, nama_pembeli) VALUES (:id_pembeli, :id_novel, :nama_pembeli)',
        [
    ...
    public function update($id, Request $request) {
        ...
        // Menggunakan Query Builder Laravel dan Named Bindings untuk valuesnya
        DB::update('UPDATE pembeli SET id_pembeli = :id_pembeli, id_novel = :id_novel, nama_pembeli = :nama_pembeli WHERE id_pembeli = :id',
        [
            'id' => $id,
            'id_pembeli' => $request->id_pembeli,
            'id_novel' => $request->id_novel,
